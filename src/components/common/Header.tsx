            ...
            <div className="relative hidden lg:block">
              ...
              {userDropdownOpen && isLoggedIn ? (
                <div className="absolute right-0 top-[calc(100%+0.5rem)] w-72 rounded-lg border border-hairline bg-white p-3 animate-fadeIn">
                  ...
                  {currentUser?.isAdmin && (
                    <button type="button" onClick={() => navigateTo('admin-users')} className="flex min-h-11 w-full items-center justify-between rounded-md px-3 text-left text-sm font-semibold text-brand-primary hover:bg-parchment">Quản trị hội viên <ChevronRight className="size-4" /></button>
                  )}
