...
export const QuickLoginModal: React.FC<QuickLoginModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/60 backdrop-blur-sm flex items-center justify-center p-3 sm:p-4 animate-fadeIn font-sans">
      <div role="dialog" aria-modal="true" aria-labelledby="quick-login-title" className="bg-white rounded-lg shadow-2xl border border-hairline max-w-md w-full overflow-hidden my-6 transform transition-all">
        {/* Header */}
        <div className="bg-[#1c1d1f] text-white p-5 relative">
          ...
          <div className="flex items-center gap-2 mb-1">
            <span className="w-6 h-6 rounded bg-brand-primary text-white text-xs font-semibold flex items-center justify-center">
              VCF
            </span>
          ...
          <h3 id="quick-login-title" className="text-base sm:text-lg font-semibold text-white">
        ...
        <div className="p-5 sm:p-6 space-y-4">
          ...
          <div className="flex border border-hairline p-1 bg-neutral-100 text-xs rounded-full">
            <button
              ...
              className={`flex-1 py-1.5 font-semibold rounded-full transition-all cursor-pointer ${
                authMode === 'password' ? 'bg-brand-primary text-white shadow-xs' : 'text-neutral-700 hover:text-ink'
              }`}
            >
              Mật khẩu
            </button>
            <button
              ...
              className={`flex-1 py-1.5 font-semibold rounded-full transition-all cursor-pointer ${
                authMode === 'otp' ? 'bg-brand-primary text-white shadow-xs' : 'text-neutral-700 hover:text-ink'
              }`}
            >
              Mã OTP Email
            </button>
          ...
          {error && (
            <div className="p-3 bg-red-50 border border-red-200 text-brand-primary text-xs rounded-lg flex items-center gap-2 font-medium">
          ...
          {authMode === 'password' && (
            <form onSubmit={handlePasswordSubmit} className="space-y-3">
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full pl-8 pr-3 py-2 text-xs border border-neutral-300 rounded-lg bg-white focus:outline-none focus:border-brand-primary"
                  />
              ...
              <button
                ...
                className="w-full py-2.5 px-4 bg-brand-primary hover:bg-brand-primary-hover text-white font-semibold rounded-lg text-xs uppercase tracking-wide transition-all shadow-xs cursor-pointer disabled:opacity-70 mt-2"
              >
            ...
            <form onSubmit={handleOtpSubmit} className="space-y-3">
              ...
              {!otpSent ? (
                <button
                  ...
                  className="w-full py-2.5 px-4 bg-brand-primary hover:bg-brand-primary-hover text-white font-semibold rounded-lg text-xs uppercase tracking-wide cursor-pointer transition-all"
                >
                  GỬI MÃ OTP VỀ EMAIL
                </button>
              ) : (
                <div className="space-y-2.5 animate-fadeIn">
                  <div className="p-2 bg-emerald-50 border border-emerald-200 rounded-lg text-[11px] text-emerald-800 flex items-center justify-between">
                    <span>Mã thử nghiệm: <strong className="font-mono text-emerald-950 font-semibold">{demoOtp}</strong></span>
                    <button
                      type="button"
                      onClick={() => setOtpCode(demoOtp)}
                      className="px-2 py-0.5 bg-emerald-700 text-white rounded font-semibold text-[10px] cursor-pointer"
                    >
                      Điền nhanh
                    </button>
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full py-2 text-center font-mono text-lg font-semibold border border-neutral-300 rounded-lg bg-white focus:outline-none focus:border-brand-primary"
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full py-2.5 px-4 bg-brand-primary hover:bg-brand-primary-hover text-white font-semibold rounded-lg text-xs uppercase tracking-wide cursor-pointer disabled:opacity-50"
                  >
          ...
          <div className="pt-1">
            <div className="relative flex items-center justify-center py-1">
              ...
              <span className="bg-white px-2 text-[10px] font-semibold text-neutral-400 uppercase tracking-wider absolute">
                Hoặc
              </span>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2 mt-2">
              <button
                ...
                className="flex items-center justify-center gap-1.5 py-2 px-3 border border-hairline hover:bg-parchment rounded-lg text-xs font-semibold text-neutral-700 transition-colors cursor-pointer"
              >
          ...
          <button
            ...
            className="w-full py-2 px-3 bg-neutral-100 hover:bg-neutral-200 text-neutral-800 rounded-lg text-xs font-semibold transition-colors flex items-center justify-center gap-1.5 cursor-pointer border border-neutral-300"
          >
