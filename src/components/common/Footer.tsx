  ...
  return (
    <footer className={`border-t border-black/8 bg-parchment text-ink ${isEventDetail ? 'pb-20 lg:pb-0' : ''}`}>
      <div className="vcf-container py-6">
        <div className="grid gap-0 md:gap-10 pb-8 md:pb-12 md:grid-cols-2 lg:grid-cols-5 lg:gap-12">
          <div className="pb-6 md:pb-0 lg:col-span-5 xl:col-span-5">
            <div>
              <button
                type="button"
              ...
              <p className="mt-5 w-full max-w-xl text-sm leading-6 text-ink-secondary">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-0 md:gap-8 lg:gap-4 xl:gap-6 lg:col-span-5 xl:col-span-5">
            {/* A. Hệ tri thức */}
            <div>
              ...
              <div className={`${openSection === 'knowledge' ? 'block' : 'hidden'} md:block`}>
                ...
                <ul className="space-y-1.5 pb-3 text-sm text-ink-secondary md:pb-0">
                  <li><button type="button" onClick={() => navigateTo('knowledge', { category: 'hung-bt' })} className="min-h-9 text-left hover:text-brand-primary cursor-pointer">Tác giả BT. Nguyễn Mạnh Hùng</button></li>
                  <li><button type="button" onClick={() => navigateTo('knowledge', { category: 'other-authors' })} className="min-h-9 text-left hover:text-brand-primary cursor-pointer">Góc nhìn chuyên gia</button></li>
                  <li><button type="button" onClick={() => navigateTo('knowledge', { category: 'derived-knowledge' })} className="min-h-9 text-left hover:text-brand-primary cursor-pointer">Tri thức phái sinh</button></li>
            ...
            <div>
              ...
              <div className={`${openSection === 'activities' ? 'block' : 'hidden'} md:block`}>
                ...
                <ul className="space-y-1.5 pb-3 text-sm text-ink-secondary md:pb-0">
                  ...
                  <li><button type="button" onClick={() => navigateTo('activities')} className="min-h-9 font-medium text-brand-primary hover:text-brand-primary-hover cursor-pointer">Xem thêm →</button></li>
                </ul>
              </div>
            </div>
            ...
            {/* F. Liên hệ cạnh mục Giới thiệu trên desktop */}
            <div className="hidden lg:block">
              <h2 className="mb-4 text-sm font-semibold">Liên hệ</h2>
              <address className="space-y-3 text-sm not-italic text-ink-secondary">
                <p className="flex items-start gap-2"><MapPin className="mt-0.5 size-4 shrink-0 text-brand-primary" />122 Hoàng Quốc Việt, Cầu Giấy, Hà Nội</p>
                <p className="flex items-center gap-2"><Phone className="size-4 shrink-0 text-brand-primary" />(024) 3756 2186 · 0988 123 456</p>
                <p className="flex items-center gap-2"><Mail className="size-4 shrink-0 text-brand-primary" />vcf@ptit.edu.vn</p>
              </address>
            </div>
