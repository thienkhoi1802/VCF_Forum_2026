...
export const ProgramsPage: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 lg:px-8 py-6 pb-24 space-y-12 font-sans">
      {showSpecAnnotations && (
        <div className="bg-neutral-100 border border-hairline p-2.5 rounded-lg text-xs font-mono flex items-center justify-between flex-wrap gap-2">
          ...
          <span className="text-ink-secondary">State: [S-DEFAULT]</span>
        </div>
      )}
      ...
      {/* Key Highlights Grid */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 border border-hairline bg-white rounded-lg p-6 md:p-8 shadow-xs">
