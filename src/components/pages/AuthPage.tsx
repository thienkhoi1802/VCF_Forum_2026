...
export const AuthPage: React.FC = () => {
  const { navigateTo, login, loginWithAccount, loginWithPassword, showSpecAnnotations, showNotification } = useApp();
  ...
  const handlePasswordLogin = async (e: React.FormEvent) => {
    ...
    // Giữ tài khoản demo hiện tại để kiểm thử wireframe; tài khoản thật đi qua Supabase Auth.
    ...
    showNotification('Đăng nhập Supabase thành công!');
    navigateTo('profile');
  };
